...
# export MYTOKEN=
# usage: bash ./jpd-data-collection.sh https://Artifactory.jfrog.io  ${MYTOKEN} sh/saas [true/false]

### sample cmd to run -> bash ./jpd-data-collection.sh https://Artifactory.jfrog.team **** sh true
